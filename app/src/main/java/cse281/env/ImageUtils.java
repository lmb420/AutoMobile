...
public class ImageUtils {
    ...
    private static final String TAG = "cse281.env.ImageUtils";

    static {
        try {
            System.loadLibrary("automobile");
            Log.i(TAG, "Native library successfully linked");
    ...
    public static void saveBitmap(final Bitmap bitmap, final String filename) {
        ...
        Log.i(TAG, format("Saving %dx%d bitmap to %s.", bitmap.getWidth(), bitmap.getHeight(), root));
    ...
    public static void convertYUV420SPToARGB8888(
        ...
        Log.i(TAG,
                "Hello from Java implementation");
    ...
    public static Matrix getTransformationMatrix(
        ...
        if (applyRotation != 0) {
            if (applyRotation % 90 != 0) {
                Log.w(TAG,format("Rotation of %d % 90 != 0", applyRotation));
            }
